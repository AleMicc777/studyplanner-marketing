...
- amber `oklch(0.76 0.16 62)` (+ hover `0.7 0.16 60`, line `0.66 0.145 62`, deep `0.55 0.12 60`) — CTAs, key metrics, validation accents, the full-bleed stat band
- valid `oklch(0.72 0.15 150)` / flag `oklch(0.66 0.19 25)` — plan-validation meaning ONLY, never decoration
